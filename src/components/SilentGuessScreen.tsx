    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-6 bg-[var(--color-bg-cream)] text-[var(--color-ink-black)]">
      ...
      >
        <div className="flex justify-between items-center mb-6 md:mb-10 text-[var(--color-ink-black)] flex-wrap gap-4">
          <h1 className="text-4xl md:text-7xl font-display drop-shadow-[2px_2px_0_var(--color-primary-gold)] md:drop-shadow-[4px_4px_0_var(--color-primary-gold)]">وضع ولا كلمة 🤫</h1>
