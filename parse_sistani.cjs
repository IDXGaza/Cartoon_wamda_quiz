...
const text = fs.readFileSync('sistani_questions.txt', 'utf-8');
...
const category = "فقه السيد السيستاني";
...
fs.writeFileSync('src/data/sistaniData.ts', out, 'utf-8');
