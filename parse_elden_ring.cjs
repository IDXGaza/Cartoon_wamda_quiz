...
const text = fs.readFileSync('elden_ring_questions.txt', 'utf-8');
...
let out = "import { BankQuestion } from './localBank';\n\nexport const ELDEN_RING_QUESTIONS: BankQuestion[] = ";
out += JSON.stringify(questions, null, 2);
out += ";\n";

fs.writeFileSync('src/data/eldenRingData.ts', out, 'utf-8');
